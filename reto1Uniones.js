...
// let reto1 ="SELECT nombre,surname,title FROM Escuela.students JOIN Escuela.marks ON (students.id_students = marks.student_id) JOIN Escuela.subjects ON(marks.subject_id = subjects.id_subjects)";
